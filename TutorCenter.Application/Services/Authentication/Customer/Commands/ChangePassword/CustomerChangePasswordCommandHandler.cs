...
public class CustomerChangePasswordCommandHandler : IRequestHandler<CustomerChangePasswordCommand, Result<AuthenticationResult>>
{
    ...
    public async Task<Result<AuthenticationResult>> Handle(CustomerChangePasswordCommand command, CancellationToken cancellationToken)
    {
